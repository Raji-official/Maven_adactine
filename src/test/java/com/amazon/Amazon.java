...
public class Amazon {
	...
	//
		...
		System.out.println(inptext);
		 ...
		 List<WebElement> findElements = driver.findElements(By.xpath("//input[@id='twotabsearchtextbox']//parent::div//parent::div//ancestor::header//following-sibling::div//div[@class='s-suggestion-container']"));
	...
	//
			...
			TakesScreenshot screen=(TakesScreenshot)driver;
		    File decFile=screen.getScreenshotAs(OutputType.FILE);
		    File des=new File(".\\screenshot\\amazon_1.png");
		    FileHandler.copy(decFile, des);
