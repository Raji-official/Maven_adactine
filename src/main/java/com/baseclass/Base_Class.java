package com.baseclass;
	...
	public class Base_Class {
		...
		public static void syso( WebElement ele) {
			try {
...
//				throw new RuntimeException();
		...
		public static void getElementTexts(List<WebElement> element,List<String> v) {
			try {
		...
		public static void parseint(List<WebElement> element,List<Integer>values) {
			try {
				for (int i = 0; i <element.size(); i++) {
					String text = element.get(i).getText();
